...
fig1= px.line(df, x=df.index, y=['distance_rightkneehip', 'distance_rightkneehips_anomalien'], title='Anomalien Hüfte - Knie rechts')
fig1.show()
...
fig2 = px.line(df, x=df.index, y=['LEFT_HIP_x_back', 'a_lefthipx'], title='Anomalien LEFT_HIP_X')
fig2.show()
